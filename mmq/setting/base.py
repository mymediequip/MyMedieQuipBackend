"""
Django settings for mmq project.
...
FILE_BASE_DIR = Path(__file__).resolve().parent.parent.parent
...
SECRET_KEY = 'django-insecure-083=*p65q1vyd=vn+mcynwfvczk77=-1_xj$0#n_s2(+%5qi6)'
...
WSGI_APPLICATION = 'mmq.wsgi.application'
...
AUTHENTICATION_BACKENDS = ( 
    'mmq.auth_backend.PasswordlessAuthBackend',
    'mmq.auth_admin.UsersModelBackend',
)
...
FILE_UPLOAD_MAX_MEMORY_SIZE = 10485760 #allow upload file size to 10 MB
